...
async function uploader() {
  ...
  if (currentID > endID) {
    ...
    const ErrorClient = new EmailError(
      `RULE34 upload script has failed ${failCount.failed_count} times. Investigate for further issues!`
    );
    ...
    const thumbnail = `/home/scripting/Guardian/script/image-store/rule34/thumbnail/rule34-post_id-${currentID}.jpg`;
    const md5 = post.md5;
