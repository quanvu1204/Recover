...
async function uploader() {
    ...
    if (currentID > 7000000) {
        ...
        const ErrorClient = new EmailError(`ZEROCHAN upload script has failed ${failCount.failed_count} times. Investigate for further issues!`);
        ...
        console.log(`ZEROCHAN upload script has failed ${failCount.failed_count} times, exiting for now...`);
          ...
          return StorageClient.deletePost(currentID);
            ...
            try {
                ...
                .then(async text => {
                    ...
                    if (response.success !== true && (response.code && response.code !== "file_uploading_in_another_thread")) {
                        ...
                        console.log(`Failed to upload ZEROCHAN#${currentID}. Error(s): ${text}`);
                ...
                console.log(error);
                StorageClient.addRetry();
                console.log(`ZEROCHAN#${currentID} will need to be retried, API error.`);
                return currentID = currentID + 1;
            }
        } else { 
            ...
            .then(async text => {
                ...
                if (response.success !== true) {
                    ...
                    console.log(`Failed to update ZEROCHAN#${currentID}. Error(s): ${text}`);
...
async function authorizer() {
    ...
    const body = { login: process.env.REICHAN_USERNAME, password: process.env.REICHAN_PASSWORD };
