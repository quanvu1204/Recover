...
async function uploader() {
    ...
    if (currentID > 7000000) {
        ...
        const ErrorClient = new EmailError(`RULE34 upload script has failed ${failCount.failed_count} times. Investigate for further issues!`);
        ...
        console.log(`RULE34 upload script has failed ${failCount.failed_count} times, exiting for now...`);
          ...
          return StorageClient.deletePost(currentID);
            ...
            try {
                ...
                .then(async text => {
                    ...
                    if (response.success !== true && (response.code && response.code !== "file_uploading_in_another_thread")) {
                        ...
                        console.log(`Failed to upload RULE34#${currentID}. Error(s): ${text}`);
            ...
            .then(async text => {
                ...
                if (response.success !== true) {
                    ...
                    console.log(`Failed to update RULE34#${currentID}. Error(s): ${text}`);
...
async function authorizer() {
    ...
    const body = { login: process.env.XXXIV_USERNAME, password: process.env.XXXIV_PASSWORD };
...
if (process.argv[2] !== "stop") {
    ...
    console.log(`RULE34 upload script started with beginning ID ${startID}.`);
