...
async function uploader() {
    ...
    if (currentID > 7000000) {
        console.log(`YANDERE upload script has finished.`);
        ...
        const ErrorClient = new EmailError(`YANDERE upload script has failed ${failCount.failed_count} times. Investigate for further issues!`);
        ...
        console.log(`YANDERE upload script has failed ${failCount.failed_count} times, exiting for now...`);
          ...
          return StorageClient.deletePost(currentID);
            ...
            try {
                ...
                .then(async text => {
                    ...
                    if (response.success !== true && (response.code && response.code !== "file_uploading_in_another_thread")) {
                        ...
                        console.log(`Failed to upload YANDERE#${currentID}. Error(s): ${text}`);
            ...
            .then(async text => {
                ...
                if (response.success !== true) {
                    ...
                    console.log(`Failed to update YANDERE#${currentID}. Error(s): ${text}`);
...
async function authorizer() {
    ...
    const body = { login: process.env.SYSTEM_USERNAME, password: process.env.SYSTEM_PASSWORD };
